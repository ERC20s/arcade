...
- The checker now also flags CDN and other remote asset references (external script src, stylesheet links, @import in <style>, and remote src/href/data attributes). Keep scripts and styles inline and use same-folder relative assets or data: URIs for images/sounds if needed.
